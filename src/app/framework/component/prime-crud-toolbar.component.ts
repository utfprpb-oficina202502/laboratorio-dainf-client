  ...
  template: `
    <p-toolbar class="mb-3" [attr.aria-label]="toolbarAriaLabel">
      <ng-template pTemplate="start">
        <ng-container *ngIf="toolbarStartTemplate; else defaultStart" [ngTemplateOutlet]="toolbarStartTemplate"></ng-container>
      </ng-template>

      <ng-template pTemplate="end">
        <ng-container *ngIf="toolbarEndTemplate; else defaultEnd" [ngTemplateOutlet]="toolbarEndTemplate"></ng-container>
      </ng-template>
    </p-toolbar>

    <ng-template #defaultStart>
      <p-button
        *ngIf="list.canCreate && !list.isReadOnly"
      ...
      <p-button
        *ngIf="list.canDelete && !list.isReadOnly"
        severity="danger"
        class="me-2"
        [outlined]="true"
    ...
    <ng-template #defaultEnd>
      <ng-container *ngIf="list.tableConfig.expandable">
        <p-button
          type="button"
          class="me-2"
          [outlined]="true"
      ...
      <p-multiSelect
        *ngIf="list.tableConfig.columnToggle !== false"
        #columnToggle
